    ...
    for (const file of files) {
        ...
        for (const { value, index } of highEntropyStrings) {
            ...
            findings.push({
                ...
                description: "A string with high randomness was found, which may be a hardcoded secret or token.",
                recommendation: "Review this string. If it is a secret, move it to environment variables.",
...
function findHighEntropyStrings(content) {
    const results = [];
